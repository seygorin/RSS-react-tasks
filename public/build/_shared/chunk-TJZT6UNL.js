import { createSlice } from '/build/_shared/chunk-BXGS4RVO.js';
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(
      type,
      '"app/context/ThemeContext.tsx"' + id,
    );
  };
  window.$RefreshSig$ =
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = '1723149151024.8132';
}
...
var ThemeProvider = ({ children, initialTheme }) => {
  _s2();
  const [theme, setTheme] = (0, import_react.useState)(initialTheme || 'light');
  const toggleTheme = () => {
...
_s2(ThemeProvider, 'N8CV/TBjaKJxBQpQWxSUE0bhl5w=');
_c = ThemeProvider;
var _c;
...
var Button_module_default = {
  button: 'Button-module__button__Mxh5t',
  'pagination-button': 'Button-module__pagination-button__KcpSC',
  'search-button': 'Button-module__search-button__OYIlU',
  'error-boundary-button': 'Button-module__error-boundary-button__VuxHr',
  'toggle-theme-button': 'Button-module__toggle-theme-button__HuaIf',
};
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(
      type,
      '"app/components/Button/Button.tsx"' + id,
    );
  };
  window.$RefreshSig$ =
    window.$RefreshRuntime$.createSignatureFunctionForTransform;
...
var Button = ({ variant = 'default', className, ...props }) => {
  const variantClass = {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
    'button',
    { className: `${variantClass} ${className}`, ...props },
    void 0,
    false,
    {
...
//# sourceMappingURL=/build/_shared/chunk-TJZT6UNL.js.map
