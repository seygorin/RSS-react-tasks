...
var init_dist2 = __esm({
  'node_modules/react-router-dom/dist/index.js'() {
    ...
    NavLink = /* @__PURE__ */ React2.forwardRef(
      function NavLinkWithRef(_ref8, ref) {
        let {
...
function Scripts(props) {
  ...
  let initialScripts = React8.useMemo(() => {
    ...
    let routeModulesScript = !isStatic
      ? ' '
      : `${(_manifest$hmr = manifest.hmr) !== null && _manifest$hmr !== void 0 && _manifest$hmr.runtime ? `import ${JSON.stringify(manifest.hmr.runtime)};` : ''}${enableFogOfWar ? '' : `import ${JSON.stringify(manifest.url)}`};
              ...
              routeIds.map(async (id) => {
                ...
                let imported = await import(
                  assetsManifest.routes[id].module +
                    `?t=${(_assetsManifest$hmr = assetsManifest.hmr) === null || _assetsManifest$hmr === void 0 ? void 0 : _assetsManifest$hmr.timestamp}`
                );
                return [
                  id,
                  {
...
@remix-run/react/dist/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=/build/_shared/chunk-DG2LPO6O.js.map
