...
import { useLocation, useNavigate } from '/build/_shared/chunk-DG2LPO6O.js';
...
var Card_module_default = {
  'result-item': 'Card-module__result-item__kzOWQ',
  'attributes-grid': 'Card-module__attributes-grid__bQmZO',
};
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(
      type,
      '"app/components/Card/Card.tsx"' + id,
    );
  };
  window.$RefreshSig$ =
...
var Card = ({ person }) => {
  ...
  const isSelected = useSelector(
    (state) => !!state.selectedItem.selectedItems[person.url],
  );
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
    'li',
    {
      className: Card_module_default['result-item'],
      children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
          'div',
          {
            className: Card_module_default['checkbox-container'],
          ...
          'div',
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
                'div',
                {
                  className: Card_module_default['attributes-grid'],
                  children: [
                    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
                      'p',
                      {
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(
      type,
      '"app/components/Loading/Loading.tsx"' + id,
    );
  };
  window.$RefreshSig$ =
    window.$RefreshRuntime$.createSignatureFunctionForTransform;
...
var Loading = () => {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
    'p',
    { className: Loading_module_default['loading'], children: 'Loading...' },
    void 0,
    false,
    {
...
var ErrorMessage_module_default = {
  'error-message': 'ErrorMessage-module__error-message__0YU6-',
};
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(
      type,
      '"app/components/ErrorMessage/ErrorMessage.tsx"' + id,
    );
  };
  window.$RefreshSig$ =
    window.$RefreshRuntime$.createSignatureFunctionForTransform;
...
var ErrorMessage = ({ message }) => {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(
    'div',
    {
      className: ErrorMessage_module_default['error-message'],
...
var NoResults_module_default = {
  'no-results': 'NoResults-module__no-results__vQg5T',
};
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(
      type,
      '"app/components/NoResults/NoResults.tsx"' + id,
    );
  };
  window.$RefreshSig$ =
    window.$RefreshRuntime$.createSignatureFunctionForTransform;
...
var NoResults = ({ message = 'Nothing found' }) => {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(
    'p',
    { className: NoResults_module_default['no-results'], children: message },
    void 0,
    false,
    {
...
var details_module_default = {
  'details-container': 'details-module__details-container__qGOM-',
};
...
var DetailsPage = ({ id }) => {
  _s2();
  const { person, isLoading, error } = usePersonDetails_default(id);
  if (isLoading)
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(
    'div',
    {
      className: details_module_default['details-container'],
