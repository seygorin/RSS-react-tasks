import {
  ...
  details_id_default,
  require_node,
} from '/build/_shared/chunk-HZB4MVP7.js';
import {
  Button_default,
  setPage,
  setPeople,
...
var useMainPage = () => {
  const [isInitialLoadComplete, setIsInitialLoadComplete] = (0,
...
var CardList_module_default = {
  'result-list': 'CardList-module__result-list__Ov0Gv',
};
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(
      type,
      '"app/components/CardList/CardList.tsx"' + id,
    );
  };
  window.$RefreshSig$ =
...
var CardList = ({ people }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(
    'ul',
    {
      className: CardList_module_default['result-list'],
...
var Pagination_module_default = {
  pagination: 'Pagination-module__pagination__Ri-g8',
};
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(
      type,
      '"app/components/Pagination/Pagination.tsx"' + id,
    );
  };
  window.$RefreshSig$ =
    window.$RefreshRuntime$.createSignatureFunctionForTransform;
...
var Results_module_default = {
  'results-container': 'Results-module__results-container__R8rTH',
};
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(
      type,
      '"app/components/Result/Results.tsx"' + id,
    );
  };
  window.$RefreshSig$ =
    window.$RefreshRuntime$.createSignatureFunctionForTransform;
...
var Results = ({ searchTerm }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(
    'div',
    {
      className: Results_module_default['results-container'],
      children:
                  ...
                  /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(
                    Pagination_default,
                    {
                      ...
                      totalPages: Math.ceil(
                        ((data == null ? void 0 : data.count) || 0) / 10,
                      ),
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(
      type,
      '"app/components/Flyout/Flyout.tsx"' + id,
    );
  };
  window.$RefreshSig$ =
    window.$RefreshRuntime$.createSignatureFunctionForTransform;
...
var Flyout = () => {
  ...
  const selectedItems = useSelector(
    (state) => state.selectedItem.selectedItems,
  );
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(
    'div',
    {
      className: Flyout_module_default['flyout'],
      children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(
          'p',
          { children: [selectedCount, ' items are selected'] },
          void 0,
          true,
          {
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(
          Button_default,
          { variant: 'search', onClick: handleDownload, children: 'Download' },
          void 0,
          false,
          {
            fileName: 'app/components/Flyout/Flyout.tsx',
...
var SearchInput_module_default = {
  'search-form': 'SearchInput-module__search-form__6PHcF',
  'search-input': 'SearchInput-module__search-input__98lk3',
};
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(
      type,
      '"app/components/SearchInput/SearchInput.tsx"' + id,
    );
  };
  window.$RefreshSig$ =
    window.$RefreshRuntime$.createSignatureFunctionForTransform;
...
var SearchInput = ({ onSearch, initialSearchTerm }) => {
  _s3();
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(
    'form',
    {
      className: SearchInput_module_default['search-form'],
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(
          ...
          {
            type: 'text',
            className: SearchInput_module_default['search-input'],
            value: searchTerm,
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(
          Button_default,
          { type: 'submit', variant: 'search', children: 'Search' },
          void 0,
          false,
          {
            fileName: 'app/components/SearchInput/SearchInput.tsx',
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(
      type,
      '"app/components/Header/Header.tsx"' + id,
    );
  };
  window.$RefreshSig$ =
    window.$RefreshRuntime$.createSignatureFunctionForTransform;
...
var Header = ({ throwError }) => {
  _s4();
  const { theme, toggleTheme } = useTheme();
  const { searchTerm, handleSearch } = useSearch_default();
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(
    'header',
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(
          SearchInput_default,
          { onSearch: handleSearch, initialSearchTerm: searchTerm },
          void 0,
          false,
          {
            fileName: 'app/components/Header/Header.tsx',
...
var index_module_default = {
  'main-page': 'index-module__main-page__6YGPJ',
  'bottom-section': 'index-module__bottom-section__Oo0MN',
  'content-section': 'index-module__content-section__mOZ-z',
  'left-section': 'index-module__left-section__1JH8l',
  'right-section': 'index-module__right-section__V6XGd',
};
...
var MainPage = () => {
  ...
  const { isInitialLoadComplete, closeDetails } = useMainPage_default();
  const navigate = useNavigate();
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(
    'main',
    {
      className: index_module_default['main-page'],
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(
          'div',
          {
            className: index_module_default['content-section'],
            children: [
              /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(
                'div',
                {
                  className: index_module_default['left-section'],
                  children:
                    isInitialLoadComplete &&
                    /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(
                      Results_default,
              ...
              showDetails &&
                /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(
                  'div',
                  {
                    className: index_module_default['right-section'],
                    children: [
                      /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(
                        details_id_default,
                        { id },
...
//# sourceMappingURL=/build/routes/_index-F4KZ25TR.js.map
